      ...
      <div className="max-w-md mx-auto bg-white/95 backdrop-blur-md p-8 rounded-3xl shadow-xl border border-amber-100 mt-6">
        {authMode === 'landing' ? (
          <div className="text-center space-y-6">
            <h2 className="text-2xl font-black text-gray-900 drop-shadow-sm">ברוכות הבאות!</h2>
            <h2 className="text-1xl font-black text-gray-900 drop-shadow-sm"> אימוני כושר עם תהל בן משה 💪</h2>
